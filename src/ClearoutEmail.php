...
namespace workwithtom\clearoutemail;

use workwithtom\clearoutemail\models\Settings;
use workwithtom\clearoutemail\widgets\Reports as ReportsWidget;
 ...
 */
class ClearoutEmail extends Plugin
{
    // Static Properties
    // =========================================================================
 ...
 */
        Craft::info(
            Craft::t(
                'clearout-email-validation-&amp;-verification',
                '{name} plugin loaded',
                ['name' => $this->name]
            ),
            __METHOD__
    ...
    protected function settingsHtml(): string
    {
        return Craft::$app->view->renderTemplate(
            'clearout-email-validation-&amp;-verification/settings',
            [
