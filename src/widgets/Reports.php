...
namespace workwithtom\clearoutemail\widgets;

use workwithtom\clearoutemail\ClearoutEmail;
use workwithtom\clearoutemail\assetbundles\reportswidget\ReportsWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Clearout email validation & verification Widget
 *
...
class Reports extends Widget
{
    ...
    {
        return Craft::t('clearout-email', 'Reports');
    }
    ...
    {
        return Craft::getAlias("@workwithtom/clearoutemail/assetbundles/reportswidget/dist/img/Reports-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'clearout-email/_components/widgets/Reports_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ReportsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'clearout-email/_components/widgets/Reports_body',
            [
